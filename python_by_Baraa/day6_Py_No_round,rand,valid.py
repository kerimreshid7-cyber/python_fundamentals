...
import math       # this is library in python to use mathimathical oprations .
...
# validation   
n=23
print(n.is_integer)             # to validate our value using .is_integer.

print(isinstance(n,float))      # to validate our value using isinstance 

# we will get True False
