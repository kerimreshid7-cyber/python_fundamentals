"""Project description: Grade Distribution.
This script creates a visualization that explores grade distribution in the dataset for the 90 Days of Visualization Challenge."""
