"""Project description: Gpa Vs Score.
This script creates a visualization that explores gpa vs score in the dataset for the 90 Days of Visualization Challenge."""
