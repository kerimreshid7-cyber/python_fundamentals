...
#  it's counter ,limited retries                 open ended waiting for DB,api and stream.    which means the program runs fore ever waiting and checing for new data that comes from api DB and live stream.


# challenge 1      ask the user while it get yes    but limit the attempts by 3
